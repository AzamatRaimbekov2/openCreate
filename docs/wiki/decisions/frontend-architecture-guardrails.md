...
- Frontend initialization must run [[frontend-error-ux-startup-required]] and document or implement any missing 404, error modal, crash fallback, or offline blocker surface.
