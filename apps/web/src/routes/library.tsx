...
// Library screen ('/library') — auth-guarded personal gallery with client-side
// type filter chips. Composition only: the Gallery module owns list/polling/
// delete logic; the route holds just the page-local filter selection.
