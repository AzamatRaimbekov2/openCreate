...
## Dependencies
- Imports / depends on: `fastify`, `./config` (type), `./db/client` (`Db` type), `./modules/auth/auth`, `./modules/auth/plugin`, `./modules/users/routes`, `./modules/credits/routes`.
